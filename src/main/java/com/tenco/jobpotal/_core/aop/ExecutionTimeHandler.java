package com.tenco.jobpotal._core.aop;
...
public class ExecutionTimeHandler {
     ...
     * 3.
     * PointCut
     * 어떤 메서드가 실행될 때 (Advice) 가 동작할지 지정 함
     * (표현식 지정 가능 - excution(* com.tenco.blog..*(..)) )
     *
     * 4.
     * 어떤 일을 수행 해야 하는지 구체적으로 명시
     */
    ...
    public Object logExecutionTime(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 예시 : 학교의 행사를 진행하는 담당자, 행사 진행 전 준비, 끝나고 마무리를 챙김
        // "이제 행사 시작" 신호를 주면 실제 행사(메서드)가 진행 됨

        // 1. 요청 시작 시간을 기록
        long startTime = System.currentTimeMillis();

        // 2. 원래 진행 하고자 하는 메서드를 진행 하라고 신호를 줌
        Object result;
        try {
