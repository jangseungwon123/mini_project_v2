...
public class ApplInfoRequest {
    ...
    public static class SaveDTO {
        ...
        public ApplInfo toEntity(LoginUser loginUser, Resume resume ,JobPost jobPost) {
    ...
    public static class UpdateStatusDTO {
        ...
        public ApplInfo toEntity(LoginUser loginUser, Resume resume , JobPost jobPost, String status , ApplInfo applInfo) {
            return ApplInfo.builder()
