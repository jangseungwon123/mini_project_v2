...
//
//    // 회원 정보 조회
//    public UserResponse.DetailDTO findByrId(String requestUserId, String sessionUserId) {
//        if (!requestUserId.equals(sessionUserId)) {
//            throw new Exception403("본인 정보만 조회 가능합니다");
//        }
//        User selectedUser = userJpaRepository.findByUserId(requestUserId).orElseThrow(() -> {
...
//    //회원 정보 수정
//    @Transactional
//    public UserResponse.UpdateDTO updateById(String requestUserId, String sessionUserId, UserRequest.UpdateDTO updateDTO) {
//        if (!requestUserId.equals(sessionUserId)) {
//            throw new Exception403("본인 정보만 조회 가능합니다");
//        }
//        User selectedUser = userJpaRepository.findByUserId(requestUserId).orElseThrow(() -> {
